  ...
  return (
    <section id='about'
      ...
      <div className='absolute inset-0 pointer-events-none'>
        ...
        <motion.div className='flex flex-col md:flex-row items-center md:item-stretch gap-8'
        ...
        >
          ...
          <motion.div className='relative w-[160px] h-[250px] md:w-[200px] md:h[200px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border border-[#1cd8d2]/25 flex-shrink-0'
          whileHover={{scale:1.02}}
          transition={{type:'spring', stiffness:200, daming:18}}
          >
          ...
          <p className='mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl'>
           I build scalable, modern web applications with a strong focus on clean architecture, delightful UX, and performance. My toolkit spans Java, React, Node.js, Express.js, Tailwind CSS, and RestfulAPI - bringing ideas to life from concept to production with robust APIs and smooth interfaces.
          </p>
          ...
          <div className='mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl'>
            ...
            <div className='mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justfy-center md:justify-start'>
        ...
        >
            ...
            I’m a computer science student specializing in full-stack development and scalable applications. </p>
            <p className='mt-4 text-gray-400 text-base sm:text-lg'>I enjoy designing solutions that are both efficient and user-centric.</p>
