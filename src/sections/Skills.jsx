...
import { FaJava, FaReact, FaHtml5, FaCss3, FaNodeJs, FaPython, FaDocker, FaGithub, FaGitAlt } from "react-icons/fa"
import { IoLogoJavascript } from "react-icons/io"
import { GrMysql } from "react-icons/gr";
import { SiExpress, SiMongodb, SiKubernetes, SiTailwindcss } from "react-icons/si"
...
const Skills = () => {
 ...
 useEffect(() => {
  ...
  return (
    <section id='skills' ref = {sectionRef} className='min-h-[40vh] w-full gap-8 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden'>
